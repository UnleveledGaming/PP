...
public class PowerfulPerms_Vault_Chat extends Chat {
    ...
    public String getPlayerVaultVariable(String playerName, String node, String world) {
        if (PowerfulPerms.vault_offline) {
            ...
            if (uuid == null)
                return null;
            try {
                List<com.github.gustav9797.PowerfulPermsAPI.Permission> permissions = permissionManager.getPlayerOwnPermissionsBase(uuid);
            ...
            if (p != null) {
                List<com.github.gustav9797.PowerfulPermsAPI.Permission> permissions = p.getPermissions();
                return getVaultVariable(permissions, node, world);
            }
        }
        return null;
    ...
    public String getVaultVariable(List<com.github.gustav9797.PowerfulPermsAPI.Permission> permissions, String node, String world) {
	...
	public PowerfulPerms getPlugin() {
		return plugin;
	}

	public void setPlugin(PowerfulPerms plugin) {
		this.plugin = plugin;
	}
